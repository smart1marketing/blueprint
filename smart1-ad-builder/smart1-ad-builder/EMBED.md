...
Change `HOST` if the service runs somewhere other than `ads.smart1marketing.com`.

```html
<div id="smart1-ad-builder"></div>
<script>
(function () {
  var HOST = "https://ads.smart1marketing.com";
...
**3. Point the custom domain at the Render service** so `/embed` resolves.
...
```html
<iframe src="https://ads.smart1marketing.com/embed"
