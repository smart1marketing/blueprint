...
# Absolute base used to build the public report_pdf_url (e.g. https://smart1recruit.onrender.com).
...
def build_report_pdf(report: dict, company: str, base_url: str) -> str:
    ...
    try:
        ...
        doc = SimpleDocTemplate(path, pagesize=letter, title=f"{company} Recruitment Report",
...
def analyze():
    try:
        ...
        pdf_url = build_report_pdf(report, payload.get("company_name", "Recruitment Report"), base_url)
